...
public class PredicateAndConsumerFilterExample {
	...
	private static Consumer<Student> studentConsumer = student -> studentNameAndActivities.accept(student.getName(),student.getActivities());
	...
	public static void printNameAndActivities(List<Student> students) {
		...
		students.stream()
				.filter(filterGPA.and(filterGradeLevel))
